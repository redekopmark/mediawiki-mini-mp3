...
$wgExtensionCredits['parserhook'][] = array(
	...
	'author' => 'Sylvain Machefert, Sam J Watkins, Reddo',
	'version' => '0.2',
...
var $buttColor, $slidColor, $loadColor, $bg, $mp3, $Color, $played;
...
//		$this->slidColor = $Color ;
//		$this->loadColor = $Color ;
//		$this->buttColor = $Color ;
//		$this->bg = ''; 
...
/*		$output = '<object type="application/x-shockwave-flash" data="'.$flashFile.'" width="200" height="20">'
		...
		$output =  Html::element( 'audio', array( 'src' => $this->mp3 ) );*/
